...
<head>
    ...
    <title>Best Andaman Tour Packages & Holidays | Vision Vacation</title>
    <meta name="description" content="Explore the best Andaman tour packages with Vision Vacation. Discover beautiful islands, beaches, and customized holiday itineraries for a perfect trip.">
                    ...
                    <div class="row g-0 g-md-2 align-items-end">
                        <div class="col-12 col-xl-7">
                            <div class="block-title me-auto">
                                <small class="sub-title">Explore Andaman </small>
                                <h2 class="h1 title">Tours in Andaman</h2>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-xxl-3 col-xl-4 col-md-6 aos-init aos-animate" data-aos="fade">
                            ...
                            <div class="tour-item rounded shadow-sm hover-effect mb-4">
                                <div class="tour-img">
                                    <a href="5-nights-6-days-andaman-tour.php">
                                        <figure class="image-hover image-hover-overlay ">
                                            <img src="<?= $base_url ?>assets/img/tours/andaman.svg"
                                                srcset="<?= $base_url ?>assets/img/tours/andaman.svg 2x" alt="">
                                        </figure>
                                    </a>
                                ...
                                <div class="tour-content">
                                    <h3 class="tour-title">
                                        <a href="5-nights-6-days-andaman-tour.php" class="link-dark link-hover">Andaman
                                            Tour Package</a>
                                    </h3>
                                    ...
                                    <div class="tour-booking">
                                        ...
                                        <a href="5-nights-6-days-andaman-tour.php" class="circle-icon circle-icon-link">
