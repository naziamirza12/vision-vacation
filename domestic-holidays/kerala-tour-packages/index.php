                    ...
                    <div class="row g-0 g-md-2 align-items-end">
                        <div class="col-12 col-xl-7">
                            <div class="block-title me-auto">
                                <small class="sub-title">Explore Kerala </small>
                                <h2 class="h1 title">Tours in Kerala</h2>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-xxl-3 col-xl-4 col-md-6 aos-init aos-animate" data-aos="fade">
                            ...
                            <div class="tour-item rounded shadow-sm hover-effect mb-4">
                                <div class="tour-img">
                                    <a href="4-nights-5-days-kerala-tour.php">
                                        <figure class="image-hover image-hover-overlay ">
                                            <img src="<?= $base_url ?>assets/img/tours/kerala.svg"
                                                srcset="<?= $base_url ?>assets/img/tours/kerala.svg 2x" alt="">
                                        </figure>
                                    </a>
                                ...
                                <div class="tour-content">
                                    <h3 class="tour-title">
                                        <a href="4-nights-5-days-kerala-tour.php" class="link-dark link-hover">Kerala
                                            Tour
                                            Package</a>
                                    </h3>
                                    ...
                                    <div class="tour-booking">
                                        ...
                                        <a href="4-nights-5-days-kerala-tour.php" class="circle-icon circle-icon-link">
