                    ...
                    <div class="row g-0 g-md-2 align-items-end">
                        <div class="col-12 col-xl-7">
                            <div class="block-title me-auto">
                                <small class="sub-title">Explore Goa </small>
                                <h2 class="h1 title">Tours in Goa</h2>
                            </div>
                        </div>
                                ...
                                <div class="tour-img">
                                    <a href="3-nights-4-days-goa-dinner-cruise.php">
                                        <figure class="image-hover image-hover-overlay ">
                                            <img src="<?= $base_url ?>assets/img/tours/goa.svg"
                                                srcset="<?= $base_url ?>assets/img/tours/goa.svg 2x" alt="">
                                        </figure>
                                    </a>
                                </div>
                                <div class="tour-content">
                                    <h3 class="tour-title">
                                        <a href="3-nights-4-days-goa-dinner-cruise.php" class="link-dark link-hover">Goa
                                            Tour Package</a>
                                    </h3>
